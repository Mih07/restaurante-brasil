...
const estaFechadoHoje = datasFechado.includes(dataHojeISO);
  // --- DADOS ---
  const restaurante = { nome: "Restaurante Brasil", cor: "#2E7D32",         // Verde (Cor principal)
  corDestaque: "#FBC02D", fone: "5511995239149" };
  
  const produtos = [
    //SEGUNDA-FEIRA
    { id: 101, dia:"Segunda-feira", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Bife acebolado. ", imagem: "/bife-acebolado.png" },
    { id: 102, dia:"Segunda-feira", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Costela ao molho.", imagem: "/costela-molho.png" },
    { id: 103, dia:"Segunda-feira", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, Calabresa acebolada.", imagem: "/calabresa-acebolada.png" },
    { id: 104, dia:"Segunda-feira", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, Filé de frango grelhado.", imagem: "/file-grelhado.png" },
    
    //TERÇA-FEIRA
    { id: 105, dia:"Terça-feira", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Carne de panela com mandioca. ", imagem: "/carnepanela-mandioca.png" },
    { id: 106, dia:"Terça-feira", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Fricassê de frango.", imagem: "/fricasse-frango.png" },
    { id: 107, dia:"Terça-feira", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Calabresa com ovo.", imagem: "/calabresa.png" },
    { id: 108, dia:"Terça-feira", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, Calabresa acebolada.", imagem: "/calabresa-acebolada.png" }, 
    
    //QUARTA-FEIRA
    { id: 109, dia:"Quarta-feira", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Feijoada Completa. ", imagem: "/feijoada.png" },
    { id: 110, dia:"Quarta-feira", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Batata Recheada.", imagem: "/batata-recheada.png" },
    { id: 111, dia:"Quarta-feira", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Crepioca de legumes e queijo.", imagem: "/crepioca-legumes.png" },  
    { id: 112, dia:"Quarta-feira", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Crepioca de legumes e queijo.", imagem: "/crepioca-legumes.png" },  
    
    //QUINTA-FEIRA
    { id: 113, dia:"Quinta-feira", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Espetinho de frango. ", imagem: "/espetinho-frango.png" },
    { id: 114, dia:"Quinta-feira", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria:"Marmitas", destaque: false, desc:"Arroz, feijão, CHamburguer pizzaolo.", imagem:"/hamburguer-pizzaolo.png"},
    { id: 115, dia:"Quinta-feira", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria:"Marmitas", destaque: true, desc:"Arroz feijão, Omelete", imagem:"/omelete.png"}, 
    { id: 116, dia:"Quinta-feira", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Crepioca de legumes e queijo.", imagem: "/crepioca-legumes.png" },  
    
    //SEXTA-FEIRA
    { id: 117, dia:"Sexta-feira", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Costela com batata. ", imagem: "/costela-batata.png" },
    { id: 118, dia:"Sexta-feira", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Filé de frango parmegiana", imagem: "/frango-parmegiana.png" },
    { id: 119, dia:"Sexta-feira", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Bife acebolada.", imagem: "/bife-acebolado.png" }, 
    { id: 120, dia:"Sexta-feira", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Crepioca de legumes e queijo.", imagem: "/crepioca-legumes.png" },  
    
    //SÁBADO
    { id: 121, dia:"Sábado", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão, Feijoada Completa. ", imagem: "/feijoada.png" },
    { id: 122, dia:"Sábado", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão e Strogonoff de Frango.", imagem: "/strogonoff-frango.png" },
    { id: 123, dia:"Sábado", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão e Isca de tilápia empanada.", imagem: "/tilapia-empanada.png" },
    { id: 124, dia:"Sábado", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Crepioca de legumes e queijo.", imagem: "/crepioca-legumes.png" },  
    
    //DOMINGO
    { id: 125, dia:"Domingo", nome: "Opção 1", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Criação da Chef - Consulte a opção de hoje! ", imagem: "/criacao-chef.png" },
    //{ id: 126, dia:"Domingo", nome: "Opção 2", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão e Contra Filé acebolado.", imagem: "/contra-file-acebolado.png" },
    //{ id: 127, dia:"Domingo", nome: "Opção 3", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: true, desc: "Arroz, feijão e Tulipinha Empanada.", imagem: "/tulipinha-empanado.png" }, 
    //{ id: 128, dia:"Domingo", nome: "Opção 4", precos: {P:22.00, M:24.00, G:26.00, GG:30.00}, categoria: "Marmitas", destaque: false, desc: "Arroz, feijão, Crepioca de legumes e queijo.", imagem: "/crepioca-legumes.png" },  
                  ...
                  <div className={item.categoria === "Marmitas" ? "acoes-marmita" : "acoes-bebida"}>
                    ...
                    {item.categoria === "Marmitas" ? (
                      <div className="seletor-tamanhos-mini">
                        ...
                        <button disabled={!liberadoVenda} onClick={() => adicionarAoCarrinho(item, 'GG')}>GG</button>
                      </div>
                    ) : (
                      <button 
